...
feature 'Fulltext Ingests' do
  ...
  context 'can created and background processes executed' do
    scenario 'successfully' do
      fti = Fabricate :fulltext_ingest, file: 'spec/files/fulltext.zip'
  ...
  #     end
  #     scenario 'a link to download XML is shown on the index page' do
  #       batch = Batch.last
  #       visit batch_batch_imports_path(batch)
