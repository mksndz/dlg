...
RSpec.describe TimePeriodsController, type: :controller do
  ...
  # TimePeriodsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all time_periods as @time_periods" do
  ...
  describe "GET #new" do
    it "assigns a new time_period as @time_period" do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created time_period as @time_period" do
        post :create, {:time_period => valid_attributes}, valid_session
      ...
      it "redirects to the created time_period" do
        post :create, {:time_period => valid_attributes}, valid_session
        expect(response).to redirect_to(TimePeriod.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved time_period as @time_period" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the time_period" do
        time_period = TimePeriod.create! valid_attributes
        put :update, {:id => time_period.to_param, :time_period => valid_attributes}, valid_session
        expect(response).to redirect_to(time_period)
      end
    end

    context "with invalid params" do
      it "assigns the time_period as @time_period" do
        time_period = TimePeriod.create! valid_attributes
