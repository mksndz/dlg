...
RSpec.describe DateIndexer, type: :model do
  ...
  it 'returns an array of years given an array of values containing an normal date range' do
    dc_dates = ['1-1-1983/1-1-1990']
    expect(date_indexer.get_valid_years_for(dc_dates)).to eq %w(1983 1984 1985 1986 1987 1988 1989 1990)
  end

  it 'returns an array of years given an array of values containing an normal date range without days' do
    dc_dates = ['1-1983/7-1990']
    expect(date_indexer.get_valid_years_for(dc_dates)).to eq %w(1983 1984 1985 1986 1987 1988 1989 1990)
  end

  it 'returns an array of years given an array of values containing an normal date range without days or months' do
    dc_dates = ['1983/1990']
    expect(date_indexer.get_valid_years_for(dc_dates)).to eq %w(1983 1984 1985 1986 1987 1988 1989 1990)
  end

  it 'returns an array of years given an array of values containing an ugly date range without days or months' do
    dc_dates = ['1983-1990']
    expect(date_indexer.get_valid_years_for(dc_dates)).to eq %w(1983 1984 1985 1986 1987 1988 1989 1990)
  end

  it 'returns a single date given an array of values possible containing legit dates ' do
