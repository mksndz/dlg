...
# backup old configs
ssh solr@metasolr cp /var/solr/data/blacklight-core/conf/schema.xml /var/solr/data/blacklight-core/conf/schema.old
ssh solr@metasolr cp /var/solr/data/blacklight-core/conf/solrconfig.xml /var/solr/data/blacklight-core/conf/solrconfig.old
