...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field 'dcterms_identifier_display',  label: I18n.t('meta.search.labels.dc_identifier'), helper_method: 'linkify'
    ...
    config.view.maps.search_mode        = 'multiple_placename_sms'
