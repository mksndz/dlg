...
class DplaController < ApplicationController
  ...
  def index
    ...
    if response.code == '200'
      ...
      render json: { error: "failed with: #{uri_string}" }
    end
  end
