class UsersController < ApplicationController
  ...
  def create
    ...
    set_user_creator
    if @user.save
      redirect_to user_path(@user), notice: t('meta.defaults.messages.success.created', entity: 'User')
    else
      set_data
      render :new, alert: t('meta.defaults.messages.errors.not_created', entity: 'User')
    end
  end
  ...
  def update
    if @user.update(user_params)
      redirect_to user_path(@user), notice: t('meta.defaults.messages.success.updated', entity: 'User')
    else
      set_data
      render :edit, alert: t('meta.defaults.messages.errors.not_updated', entity: 'User')
    end
  end
  ...
  def destroy
    ...
    @user.destroy
    redirect_to users_url, notice: t('meta.defaults.messages.success.destroyed', entity: 'User')
  end
