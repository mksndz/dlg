...
curl https://gitlab.galileo.usg.edu/infra/solr-configs/meta/raw/master/meta/conf/stopwords.txt --output /opt/solr/server/solr/configsets/meta/conf/stopwords.xml
curl https://gitlab.galileo.usg.edu/infra/solr-configs/meta/raw/master/meta/conf/stopwords_en.txt --output /opt/solr/server/solr/configsets/meta/conf/stopwords_en.xml
curl https://gitlab.galileo.usg.edu/infra/solr-configs/meta/raw/master/meta/conf/synonyms.txt --output /opt/solr/server/solr/configsets/meta/conf/synonyms.xml
curl https://gitlab.galileo.usg.edu/infra/solr-configs/meta/raw/master/meta/conf/protwords.txt --output /opt/solr/server/solr/configsets/meta/conf/protwords.xml
